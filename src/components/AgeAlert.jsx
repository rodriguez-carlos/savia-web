...
const AgeAlert = ({handleClickCloseAlert}) => {
    return (
        <div className="age-alert">
            ...
            <div className="age-alert-buttons">
                <Button variant="contained" className="age-alert-enter-button" onClick={() => handleClickCloseAlert()}>SOY MAYOR DE 18 AÑOS
                </Button>
                <Button variant="text" className="age-alert-exit-button">SALIR
                </Button>
            </div>
        </div>
    )
